...
public class PrintDaoImpl implements PrintDao {
	...
	private static final String PROJECTDETAILS="SELECT a.projectid,a.projectcode,a.projectname,a.projectname AS 'name',a.projectcode AS 'code',a.labcode, a.IsCCS, a.IsMainWC, a.SanctionDate,a.PDC FROM project_master a WHERE a.projectid=:projectid AND  a.isactive=1";
