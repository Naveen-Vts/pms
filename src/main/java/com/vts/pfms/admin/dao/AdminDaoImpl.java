...
public class AdminDaoImpl implements AdminDao{
	...
	private static final String USERNAMELIST="SELECT l.loginid, l.empid,l.username, CONCAT(IFNULL(CONCAT(e.title,' '),''), e.emp_name) AS 'empname',e.labcode FROM login l , employee e WHERE e.is_active=1 AND l.isactive=1 AND l.EmpId=e.emp_id ORDER BY e.sr_no=0,e.srno"; 
