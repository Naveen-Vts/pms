...
@Entity
@Table(name = "project_training_utilization_rev")
@Getter
@Setter
public class ProjectTrainingUtilizationRev {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "training_utilization_rev_id")
    private Long trainingUtilizationRevId;
