...
@Entity
@Table(name = "project_infrastructure_utilization_rev")
@Getter
@Setter
public class ProjectInfrastructureUtilizationRev {
		
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "infrastructure_utilization_rev_id")
	private Long infrastructureUtilizationRevId;
