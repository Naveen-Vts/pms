...
public class HeaderDaoImpl implements HeaderDao {
	...
	private static final String PROJECTDETAILS="SELECT a.project_id,a.project_code,a.project_name, a.sanction_date, a.pdc FROM project_master a WHERE a.project_id=:projectid and  a.is_active='1'";
	...
	private static final String MALIST="SELECT a.milestoneactivityid,0 AS 'parentactivityid', a.activityname,a.orgstartdate,a.orgenddate,a.startdate,a.enddate,a.progressstatus,a.revisionno,(SELECT MAX(b.enddate) FROM milestone_activity b WHERE b.projectid= :ProjectId )AS 'lastEnddate' FROM milestone_activity a WHERE  a.isactive=1 AND a.projectid=:ProjectId ORDER BY a.MilestoneActivityId";
