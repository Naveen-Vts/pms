...
//	private static final String ACTIONWISEALLREPORT="CALL Pfms_Action_Wise_All_Reports (:term,:empid,:projectid);";
	...
	private static final String PROJECTEMPLIST="SELECT a.emp_id,CONCAT(IFNULL(CONCAT(a.title,' '),''), a.emp_name) as 'empname' ,b.designation FROM employee a,employee_desig b,project_employee pe  WHERE a.is_active='1' AND a.desig_id=b.desig_id  AND pe.empid=a.empid AND pe.projectid=:projectid ORDER BY a.sr_no=0,a.sr_no";
...
//		int result=query.executeUpdate();
	...
	private static final String LABEMPLOYEELIST="SELECT a.emp_id,CONCAT(IFNULL(CONCAT(a.title,' '),''), a.emp_name) as 'empname',a.emp_no,b.designation FROM employee a,employee_desig b WHERE a.is_active=1 AND a.desig_id=b.desig_id AND a.lab_code=:labcode ;";
	@Override
